...
END{
	...
	for(item in s_array){
		...
		last_array[num_gram][1] = item_array[2]	#gram本体,品詞情報
		last_array[num_gram][2] = item_array[3]	#ファイル名
		last_array[num_gram][3] = item_array[4]	#出現頻度
		last_array[num_gram][4] = item_array[1]	#グラム数
		num_gram ++
	}
	num_gram = num_gram - 1
